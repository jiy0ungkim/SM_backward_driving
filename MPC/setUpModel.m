...
%% Calculate A,B,C matrices used in MPC Model (일단 여기만 수정)
% vehicle parameters
m = 1908;
Iz = 11460;
Lf = 1.2;
...
% Discretization for MPC 
Ts_mpc   = 0.1;       % sampling time t_s

sysc = ss(A_lat, B_lat, C_lat, D_lat);
sysd = c2d(sysc, Ts_mpc);
